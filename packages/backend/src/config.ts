...
type Source = {
	...
	sentryForFrontend?: {
		...
		vueIntegration?: SentryVue.VueIntegrationOptions;
		browserTracingIntegration?: Parameters<typeof SentryVue.browserTracingIntegration>[0];
		replayIntegration?: Parameters<typeof SentryVue.replayIntegration>[0];
	};
